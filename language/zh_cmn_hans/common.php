...
$lang = array_merge($lang, array(
    ...
    'ACP_SHORT'						=> '管理后台',
    'ACTIVE'						=> '激活',
    'ACTIVE_ERROR'					=> '您指定了一个未被激活的用户名，请激活您的帐号后再试一次。如果还是有问题请联系论坛管理员。',
    'ADMINISTRATOR'					=> '管理员',
    'ADMINISTRATORS'				=> '管理员',
    'AGE'							=> '年龄',
    'AIM'							=> 'AIM',
    ...
    'ALT_TEXT'						=> '替换文字',
    'AND'							=> '和',
    'ARE_WATCHING_FORUM'			=> '您关注了这个版面，版面更新时将给您发送消息。',
    'ARE_WATCHING_TOPIC'			=> '您关注了这个主题，主题更新时将给您发送消息。',
    'ASCENDING'						=> '升序',
    'ATTACHMENTS'					=> '附件',
    ...
    'BCC'					=> 'BCC',
    'BIRTHDAYS'				=> '生日',
    'BOARD_BAN_PERM'		=> '您被这个论坛<strong>永远</strong>封禁。<br /><br />请联系 %2$s论坛管理员3$s 以得到更多的信息。',
    'BOARD_BAN_REASON'		=> '被封禁的原因: <strong>%s</strong>',
    'BOARD_BAN_TIME'		=> '您在 <strong>%1$s</strong> 之前将被禁止浏览论坛。<br /><br />请联系 %2$s论坛管理员 %3$s 以得到更多信息。',
    ...
    'LOGIN_CONFIRM_EXPLAIN'				=> '为了防止暴力破解用户密码，论坛管理员要求您在超过最大尝试次数后输入下面图片中显示的验证码。如果您无法阅读验证码，请联系 %s论坛管理员%s。',
    'LOGIN_ERROR_ATTEMPTS'				=> '您超出了论坛规定的最大尝试次数。除了您的用户名和密码外您还需要输入下图所示的验证码。',
    'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> '您的浏览未被Apache服务器授权。',
    'LOGIN_ERROR_OAUTH_SERVICE_DOES_NOT_EXIST'	=> '请求了不存在的 OAuth 服务.',
    'LOGIN_ERROR_PASSWORD'				=> '您输入了一个无效的密码。请查证后重新输入。如果一直存在问题请联系 %s论坛管理员%s。',
    'LOGIN_ERROR_PASSWORD_CONVERT'		=> '在论坛升级中无法转换您的密码. 请 %s申请一个新密码%s. 如果您还遇到其他的问题, 请联系 %s论坛管理员%s.',
    'LOGIN_ERROR_USERNAME'				=> '您输入了一个无效的用户名。请查证后重新输入。如果一直存在问题请联系 %s论坛管理员%s。',
    ...
    'POSTED_ON_DATE'		=> '于',
    'POSTS'					=> '帖子',
    'POSTS_UNAPPROVED'		=> '这个主题至少有一篇帖子审核被拒绝.',
    'POSTS_UNAPPROVED_FORUM'=> '这个版面至少有一篇帖子审核被拒绝.',
    'POST_BY_AUTHOR'		=> '由',
    ...
    'SORT_USERNAME'				=> '用户名',
    'SPLIT_TOPIC'				=> '分割主题',
    'SQL_ERROR_OCCURRED'		=> '当读取页面的时候发生SQL错误。如果错误一直存在，请联系 %s论坛管理员%s 。',
    'STATISTICS'				=> '统计数据',
    ...
    'UNREAD_POST'           => '未读帖子',
    'UNREAD_POSTS'          => '未读帖子',
    'UNWATCH_FORUM_CONFIRM'		=> '您确认要取消关注这个版面吗?',
    'UNWATCH_FORUM_DETAILED'	=> '您确认要取消关注“%s”版面吗?',
    'UNWATCH_TOPIC_CONFIRM'		=> '您确认要取消关注这个主题吗?',
    'UNWATCH_TOPIC_DETAILED'	=> '您确认要取消关注主题 “%s” 吗?',
