...
$lang = array_merge($lang, array(
    ...
    'ALT_TEXT'						=> '替换文字',
    'AND'							=> '和',
    'ARE_WATCHING_FORUM'			=> '您订阅了这个版面，版面更新时将给您发送消息。',
    'ARE_WATCHING_TOPIC'			=> '您订阅了这个主题，主题更新时将给您发送消息。',
    'ASCENDING'						=> '升序',
    'ATTACHMENTS'					=> '附件',
    ...
    'LOGIN_CONFIRM_EXPLAIN'				=> '为了防止暴力破解用户密码，论坛管理员要求您在超过最大尝试次数后输入一组确认码。确认码显示在如下所示的图片中。如果您存在视力缺陷无法阅读请联系 %s论坛管理员%s。',
