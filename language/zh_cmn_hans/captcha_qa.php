...
$lang = array_merge($lang, array(
	...
	'EDIT_QUESTION'				=> '编辑问题',
	'QUESTIONS'					=> '问题',
	'QUESTIONS_EXPLAIN'			=> '启用这个插件后在每一次提交的过程中，用户都会被问一个您设定的问题。要使用这个插件，您在论坛默认语言下要设置至少一个问题. 这个问题必须让您的访客易于理解和回答而机器人无法理解。请注意, 机器人可能使用Google™搜索这类工具来搜索答案。实际使用中一个合适的问题就足够，如果您发现开始有机器人注册，就应该更换问题了。如果问题的答案依赖于混合的大小写，标点和空格，请启用严格校验。',
