...
$lang = array_merge($lang, array(
	...
	'EDIT_QUESTION'				=> '编辑问题',
	'QUESTIONS'					=> '问题',
	'QUESTIONS_EXPLAIN'			=> '在注册的过程中, 用户会被问及您设置的问题. 要使用这个插件, 您在论坛默认语言下要设置至少一个问题. 这个问题必须让您的访客易于理解和回答而机器人无法理解. 请注意, 机器人可能使用Google™搜索这类工具来搜索答案. 使用较多数目的问题并且经常变更题目可以很好的避免机器人注册. 您可以设置严格校验来检查答案的标点和大小写是否一致.',
