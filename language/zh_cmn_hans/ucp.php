...
$lang = array_merge($lang, array(
	...
	'ADD_RULE'						=> '添加规则',
	'ADD_TO'						=> '添加【收件人】',
	'ADD_USERS_UCP_EXPLAIN'			=> '你可以在这里添加新组员。您可以选择是否让这个组成为新组员的默认群组。多个用户请分行输入.',
	...
	'CHANGE_DEFAULT_GROUP'		=> '更改默认群组',
	'CHANGE_PASSWORD'			=> '更改密码',
	'CLICK_GOTO_FOLDER'			=> '%1$s前往您的 “%3$s” 文件夹%2$s',
	'CLICK_RETURN_FOLDER'		=> '%1$s回到您的 “%3$s” 文件夹%2$s',
	'CONFIRMATION'				=> '注册验证',
	'CONFIRM_CHANGES'			=> '确认修改',
	'CONFIRM_EXPLAIN'			=> '为了防止机器自动注册行为，请输入下面的图片中显示的一组验证码。如果您无法阅读这组验证码，请联系 %s论坛管理员%s。',
	'VC_REFRESH'                => '刷新验证码',
	'VC_REFRESH_EXPLAIN'        => '如果您无法辨认当前的验证码，您可以点击按钮更换新的验证码.',
    ...
    'NOTIFICATION_TYPE_GROUP_REQUEST'					=> '有人请求加入您的群组',
    'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> '一个帖子或主题需要批准',
    'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> '您的主题/帖子被版主审核通过或拒绝',
    'NOTIFICATION_TYPE_PM'								=> '有人给您发送站内消息',
    'NOTIFICATION_TYPE_POST'							=> '有人回复了您关注的主题',
    'NOTIFICATION_TYPE_QUOTE'							=> '您被他人的帖子引用',
    'NOTIFICATION_TYPE_REPORT'							=> '有人举报了帖子',
    'NOTIFICATION_TYPE_TOPIC'							=> '有人在您关注的版面发布了主题',
	...
	'POST_REPLY_PM'				=> '回复消息',
	'PRINT_PM'					=> '打印预览',
	'PREFERENCES_UPDATED'		=> '您的偏好设置已经更新。',
	...
	'UCP_WELCOME'					=> '欢迎来到用户面板。这里您可以监视，查看和更新您的资料，偏好设置，关注版面和主题。您还可以给其他用户发送消息 (如果允许)。在继续下一步操作前请确认您已经仔细阅读了所有的公告。',
	'UCP_ZEBRA'						=> '好友与黑名单',
	...
	'WATCHED_EXPLAIN'			=> '以下是您关注的版面和主题列表。您将收到它们的更新信息。取消关注: 选中版面或主题后点击 <em>取消关注</em> 按钮。',
	...
	'GROUPS_EXPLAIN'	=> '群组设置使管理员更好的管理用户。您会处于一个默认的群组中。组定义将决定您对于其他用户的显示信息，例如您的用户名颜色，头像，级别等等。你可以改变您的默认群组，但是这取决于管理员的设置。您也可以被放入或加入其他组。一些群组将会具有额外的权限访问更多的区域。',
	'GROUP_LEADER'		=> '组长',
	'GROUP_MEMBER'		=> '组成员',
