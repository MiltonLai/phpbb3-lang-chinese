...
$lang = array_merge($lang, array(
	...
	'HELP_BBCODE_INTRO_BBCODE_ANSWER'	=> 'BBCode是一种特殊的HTML实现，是否能在帖子中使用 BBCode 取决于论坛管理员的设置。另外您也可以在发布帖子时禁用 BBCode。BBCode 和 HTML 很像，但标签是方括号 [ 和 ] 而不是 &lt; 和 &gt;，一样提供了很好的页面显示效果控制。根据使用的模板不同在界面上略有不同，您可以在文章编辑界面通过点击按钮轻松上手，快速学会使用 BBCode。尽管如此，您还是可能会在这篇帮助中找到有用的信息。',
