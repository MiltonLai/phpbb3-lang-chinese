...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_ATTACHMENTS_OWN_ANSWER'	=> '如果您想查看您上传附件的列表, 打开用户面板, 点击附件页面链接即可看到.',
	'HELP_FAQ_ATTACHMENTS_OWN_QUESTION'	=> '我怎样才能找到所有我发布的附件?',

	'HELP_FAQ_BLOCK_ATTACHMENTS'	=> '附件',
	'HELP_FAQ_BLOCK_BOOKMARKS'	=> '关注和收藏',
	...
	'HELP_FAQ_BOOKMARKS_DIFFERENCE_ANSWER'	=> '在 phpBB 3.0 中，收藏类似于浏览器中的收藏夹, 当有更新时您不会收到提示。在 phpBB 3.1 之后，收藏更类似于关注主题，在收藏的主题有更新时您将收到通知。而关注，在主题或版面内容有更新时将会通过您指定的方式通知您。收藏和关注的通知选项可以在用户面板 UCP 的“偏好设置”中设置。',
	'HELP_FAQ_BOOKMARKS_DIFFERENCE_QUESTION'	=> '收藏和关注有什么区别？',
	'HELP_FAQ_BOOKMARKS_FORUM_ANSWER'	=> '当您进入一个版面时, 在页面的底部您会看到 “关注版面” 的链接. 这个链接可以用于关注版面。',
	'HELP_FAQ_BOOKMARKS_FORUM_QUESTION'	=> '我该如何关注版面？',
	'HELP_FAQ_BOOKMARKS_REMOVE_ANSWER'	=> '取消关注, 您只需要打开用户面板，点击管理关注链接后进行取消关注操作。',
	'HELP_FAQ_BOOKMARKS_REMOVE_QUESTION'	=> '我怎样才能取消关注?',
	'HELP_FAQ_BOOKMARKS_TOPIC_ANSWER'	=> '您可以在主题讨论页的顶部或底部的“主题工具”栏里关注或者收藏这个主题。<br />在回复时勾选“有回复时通知我”也可以关注主题。',
	'HELP_FAQ_BOOKMARKS_TOPIC_QUESTION'	=> '我该如何收藏或关注主题？',
	...
	'HELP_FAQ_FORMATTING_GLOBAL_ANNOUNCE_ANSWER'	=> '全站公告包含重要的信息，您应该及时阅读。全站公告显示在每个版面的顶端和您的用户面板。发表全站公告的权限由论坛管理员管理。',
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> '您可以使用这些名单来管理论坛中的用户。加入好友名单的用户会在您的用户面板中列出，方便您快速查看在线状态和发送站内消息。另外如果有模板支持，您的好友所发表的帖子也会高亮显示。如果您将某个用户拉黑，他的帖子将对您自动隐藏。',
	'HELP_FAQ_FRIENDS_BASIC_QUESTION'	=> '什么是我的好友名单和黑名单？',
	'HELP_FAQ_FRIENDS_MANAGE_ANSWER'	=> '您可以通过两种方式添加用户到您的名单。在浏览用户资料时，页面上有链接可以点击添加好友或拉黑。另外，在您的用户面板，您也可以直接输入用户名来添加。您还可以在这个页面删除名单中的用户。',
	...
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'	=> '如果您属于多个群组，您可以设置默认群组来显示自己的群组颜色和群组级别。论坛管理员可以赋予您在用户面板中更改默认群组的权限。',
	...
	'HELP_FAQ_GROUPS_USERGROUPS_JOIN_ANSWER'	=> '要加入一个群组请点击用户面板中的群组链接，这样您可以看到所有的群组。并不是所有的群组都是 <em>开放</em> 的，一些需要申请，一些是关闭的，而另一些甚至是隐藏的。如果是开放的群组您可以直接点击加入。如果是需要申请的群组，您需要先申请加入，而后等待群组长批准后才能成为群组的成员，这个过程中他们可能会询问您加入的原因。如果申请没有被批准，请不要纠缠群组长，他们有拒绝您加入的理由。',
	...
	'HELP_FAQ_PMS_UNWANTED_ANSWER'	=> '您可以在用户面板中通过设置站内消息接收规则来拒绝来自某个用户的消息。如果您收到类似的消息，请向管理员投诉，他们有权限禁止这些用户发送站内消息。',
	...
	'HELP_FAQ_POSTING_DRAFT_ANSWER'	    => '这允许您保存一个未完成帖子以备以后发表。请到用户面板查找重新加载帖子继续编辑。',
	...
	'HELP_FAQ_SEARCH_OWN_ANSWER'	=> '您自己的帖子可以通过点击用户面板或浏览自己的资料中 “查找用户的帖子” 链接得到。 或者通过论坛顶部的快速链接菜单。如果需要搜索自己的主题，可以使用高级搜索。',
	...
	'HELP_FAQ_USERSETTINGS_AVATAR_DISPLAY_ANSWER'	=> '在用户面板的”个人资料“栏下，可以通过以下的方式添加头像：Gravatar，相册，远程或上传。哪些方法可用取决于论坛管理员是否开启了相应选项。如果您无法使用头像，请联系论坛管理员。',
	'HELP_FAQ_USERSETTINGS_AVATAR_DISPLAY_QUESTION'	=> '我该如何才能显示头像？',
	'HELP_FAQ_USERSETTINGS_AVATAR_QUESTION'	=> '用户名旁边的图片是什么？',
	'HELP_FAQ_USERSETTINGS_CHANGE_SETTINGS_ANSWER'	=> '您的所有配置信息 (如果您是注册用户) 都存储在数据库中。要修改它们请点击页首您的用户名，前往用户面板。您可以在用户面板中修改您的各种偏好设置。',
	...
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_ANSWER'	=> '在用户面板 “偏好设置” 中您可以找到选项 <em>隐藏您的在线状态</em>, 如果您启用这个选项, 将只有管理员, 版主和您自己才能看到您的在线状态. 您将会显示为隐藏用户。',
