...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'	=> '如果您属于多个群组，您可以设置默认组来显示自己的群组颜色和群组级别。论坛管理员可以赋予您在用户控制面板中更改默认群组的权限。',
	...
	'HELP_FAQ_POSTING_NO_ATTACHMENTS_ANSWER'	=> '发表附件的权限, 可以通过版面/用户/群组来设置。论坛管理员可能不允许在某些版面粘贴附件，或者只允许某些群组发表附件。如果您不清楚为什么不能发表附件，请联络论坛管理员。',
	...
	'HELP_FAQ_POSTING_QUEUE_ANSWER'	=> '论坛管理员可能设置了这个版面的帖子必须通过审批才能发表。这也可能是因为您被管理员放入了需要审批帖子的群组。请联络论坛管理员以得到更多信息。',
