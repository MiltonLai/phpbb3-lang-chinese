...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_GROUPS_MODERATORS_ANSWER'	=> '版主可以是个人或用户组，他们的工作是维护每个版面的日常运作。他们拥有在所辖版面内的编辑/删除/锁定/解锁/移动/分割主题和投票的权力。一般版主会阻止用户发表与版面无关的帖子，垃圾帖子或有冒犯内容的帖子。',
	...
	'HELP_FAQ_POSTING_QUEUE_ANSWER'	=> '论坛管理员可能设置了这个版面的帖子必须通过审批才能发表。这也可能是因为您被管理员放入了需要审批帖子的用户组。请联络论坛管理员以得到更多信息。',
