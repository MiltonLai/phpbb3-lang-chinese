...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_REGISTER_ANSWER'	=> '您不一定必须注册，这取决于论坛管理员设置是否需要您注册后才能发表帖子。但是注册将给您更多的权限来使用其他的论坛功能，例如自定义头像, 站内消息, 给好友发送email和加入用户组等等。只需要一小会儿就能完成注册，所以建议您还是注册一个帐号吧。',
	...
	'HELP_FAQ_PMS_CANNOT_SEND_ANSWER'	=> '有三个可能的原因：您还未注册或还未登录，论坛管理员禁止了站内消息，或者论坛管理员取消了您的站内消息权限。请联络管理员询问其原因。',
