...
$help = array(
	...
	array(
		0 => '什么是 BBCode?',
		1 => 'BBCode是一种特殊的HTML实现方式. 您能否在帖子中使用BBCode由管理员设置. 此外您可以在发表的时候设置帖子是否使用BBCode. BBCode本身和HTML相似, 标签由方括号[和]封装而不是 &lt; 和 &gt; 并且它能提供更多的显示控制. 取决于您使用的模板, 您会发现在发布帖子的过程中使用可点击的界面添加BBCode非常容易. 即使如此, 以下的内容对您还是很有用的.'
	),
	array(
		0 => '--',
		1 => '文本格式'
