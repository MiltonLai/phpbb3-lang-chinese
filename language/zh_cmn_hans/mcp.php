...
$lang = array_merge($lang, array(
	...
	'ALL_REPORTS'			=> '全部举报',
	'ALREADY_REPORTED'		=> '这个帖子已经被举报过了',
	'ALREADY_REPORTED_PM'	=> '这个消息已经被举报过了.',
	'ALREADY_WARNED'		=> '这个帖子已经被警告过了',
	'APPROVE'				=> '审核通过',
	'APPROVE_POST'			=> '审核通过帖子',
	'APPROVE_POST_CONFIRM'	=> '您确定要审核通过这个帖子吗？',
	'APPROVE_POSTS'			=> '审核通过帖子',
	'APPROVE_POSTS_CONFIRM'	=> '您确定要审核通过这些帖子吗？',
    'APPROVE_TOPIC'			=> '审核通过主题',
    'APPROVE_TOPIC_CONFIRM'	=> '您确定要审核通过这个主题吗?',
    'APPROVE_TOPICS'		=> '审核通过主题',
    'APPROVE_TOPICS_CONFIRM'=> '您确定要审核通过选中的主题吗?',
	...
	'DISAPPROVE'				=> '拒绝',
	'DISAPPROVE_REASON'			=> '拒绝的理由',
	'DISAPPROVE_POST'			=> '拒绝这篇帖子',
	'DISAPPROVE_POST_CONFIRM'	=> '您确定要拒绝这篇帖子吗？',
	'DISAPPROVE_POSTS'			=> '拒绝这些帖子',
	'DISAPPROVE_POSTS_CONFIRM'	=> '您确定要拒绝这些帖子吗？',
	'DISPLAY_LOG'				=> '显示记录',
	...
	'LOCK'						=> '锁定',
	'LOCK_POST_POST'			=> '锁定这个帖子',
	'LOCK_POST_POST_CONFIRM'	=> '您确定要禁止对这个帖子的编辑操作吗？',
	...
	'MCP_QUEUE_UNAPPROVED_TOPICS_EXPLAIN'	=> '这是需要审核通过后才对用户可见的主题列表',
	...
	'NOTIFY_POSTER_DISAPPROVAL'		=> '通知作者关于审核被拒绝的信息吗?',
	...
	'POSTER'					=> '作者',
	'POSTS_APPROVED_SUCCESS'	=> '成功审核通过了这些帖子',
	'POSTS_DELETED_SUCCESS'		=> '成功地删除了这些帖子',
	'POSTS_DISAPPROVED_SUCCESS'	=> '成功地拒绝了这些帖子',
	...
	'POST_APPROVED_SUCCESS'		=> '成功审核通过这个帖子',
	'POST_DELETED_SUCCESS'		=> '成功删除这个帖子',
	'POST_DISAPPROVED_SUCCESS'	=> '成功拒绝这个帖子',
	'POST_LOCKED_SUCCESS'		=> '成功锁定这个帖子',
	'POST_NOT_EXIST'			=> '您请求的帖子不存在',
	'POST_REPORTED_SUCCESS'		=> '成功举报这个帖子',
    'POST_RESTORED_SUCCESS'		=> '这个帖子已经被恢复.',
	'POST_UNLOCKED_SUCCESS'		=> '成功解除这个帖子锁定',
    ...
    'UNAPPROVED_POSTS_TOTAL'		=> array(
        0	=> '目前没有等待审核的帖子.',
        1	=> '目前共有 <strong>1</strong> 篇帖子等待审核.',
        2	=> '目前共有 <strong>%d</strong> 篇帖子等待审核.',
    ),
	'UNLOCK'						=> '解锁',
	'UNLOCK_POST'					=> '解锁帖子',
	'UNLOCK_POST_EXPLAIN'			=> '允许编辑',
	'UNLOCK_POST_POST'				=> '解锁这个帖子',
	'UNLOCK_POST_POST_CONFIRM'		=> '您确定要允许对这个帖子的编辑操作吗？',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			'WAREZ'		=> '这个帖子包含了非法或恶意软件的链接',
			'SPAM'		=> '这个帖子的目的是为其它网站或软件做广告',
			'OFF_TOPIC'	=> '此帖跑题了',
