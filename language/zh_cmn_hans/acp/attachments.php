...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> '每个文件的最大尺寸, 设为0则限制为PHP配置的最大文件尺寸.',
	'ATTACH_MAX_PM_FILESIZE'			=> '最大消息文件尺寸',
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> '每个用户消息附件的文件大小上限, 0表示无限制.',
	...
	'MAX_ATTACHMENTS_PM'			=> '每个消息的最大附件数量',
	...
	'NO_WRITE_UPLOAD'			=> '您指定的上传目录不可写入. 请更改目录权限使web服务器可以作写操作.',
