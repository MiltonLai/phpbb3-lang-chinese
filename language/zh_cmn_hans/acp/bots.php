...
$lang = array_merge($lang, array(
	...
	'BOT_DELETED'		=> '机器人删除完成.',
	'BOT_EDIT'			=> '编辑机器人',
	'BOT_EDIT_EXPLAIN'	=> '这里您可以增加或修改当前的机器人条目. 您可以设置一个机构字符串和/或多个IP地址(或者地址范围)来匹配. 当设置匹配字符串时要小心. 您也可以指定机器人浏览时看到的界面和语言. 设定一个简单的界面可以减少机器人使用的带宽. 记住给机器人群组设置合适的权限.',
	'BOT_LANG'			=> '机器人语言',
