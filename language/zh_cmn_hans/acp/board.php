...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> '允许用户上载来自另一个网站的头像.',
	'ALLOW_UPLOAD'					=> '允许头像上载',
	'AVATAR_GALLERY_PATH'			=> '头像册路径',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> '在您的phpBB论坛根目录下的预先设置的头像画册, 例如 <samp>images/avatars/gallery</samp>，<br>因为安全原因，双点路径 <samp>../</samp> 将从将被过滤',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT'			=> '新用户发文限制',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> '新用户会被归入 <em>新注册用户</em> 组直到其发表足够多的帖子. 您可以使用此群组的群组权限来限制其使用站内消息以及方便发文审核. <strong>设置为0则不启用此项功能.</strong>',
	'NEW_MEMBER_GROUP_DEFAULT'		=> '设置新注册群组为默认群组',
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> '如果设置为是, 并且设置了新用户发帖数目限制, 新用户不仅会加入到 <em>新注册用户</em> 组, 这个群组也会成为他的默认群组. 这将方便管理员为该组指定一个默认等级和组头像.',
...
//	'ACC_USER_ADMIN'			=> '用户 + 管理员',
	...
	'ALLOW_EMAIL_REUSE_EXPLAIN'	=> '不同的用户可以使用相同的Email地址注册.',
	'COPPA'						=> 'COPPA',
	'COPPA_FAX'					=> 'COPPA传真号',
...
$lang = array_merge($lang, array(
	...
	'CONFIGURE'								=> '设置',
	'CAPTCHA_NO_OPTIONS'					=> '此验证拆机没有可设置的选项.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> '以下设置了送往用户浏览器的数据。在大多数情况下使用默认设置就已足够. 如果您自行调整需要谨慎，不正确的设置将会使用户无法登录论坛。如果您论坛的用户存在无法保持登录状态的问题，请查阅<strong><a href="https://www.phpbb.com/support/go/cookie-settings">phpBB.com Knowledge Base - Fixing incorrect cookie settings</a></strong>。',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_EMAIL'					=> 'Email地址',
	'CONTACT_EMAIL_EXPLAIN'			=> '这将使用在任何需要指定联系方式的场合, 例如 垃圾信息, 错误输出, 等等. 这将总是显示在 <samp>From</samp> 和 <samp>Reply-To</samp>.',
