...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL'					=> '顶帖间隔',
	'BUMP_INTERVAL_EXPLAIN'			=> '主题中最后一个帖子发表后的天数/小时数/分钟数, 设定为0则关闭此特性.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> '如果设置为是, 并且设定了新用户发帖数目限制, 新用户不仅会加入到 <em>新注册用户</em> 组, 这个群组也会成为他的默认群组. 这将方便管理员为该组指定一个默认等级和组头像.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> '如果禁用, 论坛将不会发送任何Email. <em>注意用户激活需要启用此项功能. 如果当前设定为用户自行激活和管理员激活, 则停用此项功能将使用户无需激活.</em>',
