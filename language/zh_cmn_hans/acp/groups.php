...
$lang = array_merge($lang, array(
	...
	'ADD_USERS'						=> '添加用户',
	'ADD_USERS_EXPLAIN'				=> '这里您可以添加新用户到用户组. 您可以选择是否使用这个用户组作为用户的默认用户组. 并且您可以设置用户组组长. 如果有多个用户请在每一行输入用户名.',
	...
	'GROUP_MEMBERS'					=> '用户组成员',
	'GROUP_MEMBERS_EXPLAIN'			=> '用户组的所有成员完整列表. 包含了组长, 等待批准的成员和正式成员. 您可以管理这个组中的成员. 如果需要删除组长身份但是保留在组中, 请使用组长降级而不是删除, 同样的可以选择一个正式成员提升为组长.',
	...
	'GROUP_RECEIVE_PM_EXPLAIN'		=> '请注意隐藏的用户组不可以接收消息, 这里的设置不起作用.',
	'GROUP_REQUEST'					=> '申请',
