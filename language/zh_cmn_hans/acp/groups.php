...
$lang = array_merge($lang, array(
	...
	'ADD_USERS'						=> '添加用户',
	'ADD_USERS_EXPLAIN'				=> '这里您可以添加新用户到群组. 您可以选择是否使用这个群组作为用户的默认群组. 并且您可以设置群组领导. 如果有多个用户请在每一行输入用户名.',

	'COPY_PERMISSIONS'				=> '复制权限自',
	'COPY_PERMISSIONS_EXPLAIN'		=> '一旦创建, 群组将拥有与您选择的组同样的权限.',
	'CREATE_GROUP'					=> '创建新组',
	...
	'GROUP_MEMBERS'					=> '群组成员',
	'GROUP_MEMBERS_EXPLAIN'			=> '群组的所有成员完整列表. 包含了组领导, 等待批准的成员和正式成员. 您可以管理这个组中的成员. 如果需要删除组领导身份但是保留在组中, 请使用组领导降级而不是删除, 同样的可以选择一个正式成员提升为组领导.',
	'GROUP_MESSAGE_LIMIT'			=> '群组私人短信数量限制',
	...
	'GROUP_NAME'					=> '群组名称',
	'GROUP_NAME_TAKEN'				=> '您输入的群组名称已经被使用, 请使用其他的组名称.',
	'GROUP_OPEN'					=> '打开',
	...
	'GROUP_RANK'					=> '组级别',
	'GROUP_RECEIVE_PM'				=> '群组可以接收私人短信',
	'GROUP_RECEIVE_PM_EXPLAIN'		=> '请注意隐藏的群组不可以接收短信, 这里的设置不起作用.',
	'GROUP_REQUEST'					=> '请求',
