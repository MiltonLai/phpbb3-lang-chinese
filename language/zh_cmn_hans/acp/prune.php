...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> '这里您可以将论坛中的用户删除（或者冻结）。 你可以有多种形式搜寻，然后删除。如：发帖数量和最后一次的时间等等... 这些方式可以自由组合， 如：你可以选用2001年1月1日之前发帖量少于10篇的用户来删除。 你也可以选择批量删除，只需要将用户名单放进删除栏目中即可。 此功能须小心使用！ 一旦用户被删除后将无法再恢复。',
