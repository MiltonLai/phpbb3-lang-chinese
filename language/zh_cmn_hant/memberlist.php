...
$lang = array_merge($lang, array(
	...
	'FIND_USERNAME_EXPLAIN'	=> '用這個表單尋找特定的會員。您不必填寫所有的表格。比對部分字元可以使用 * 萬用字元。當輸入日期時請使用格式 <kbd>YYYY-MM-DD</kbd>，如: <samp>2004-02-29</samp>。使用多重選框選擇一個或多個會員名稱（是否接受多個會員名稱取決於表單本身）並點擊選擇選取的按鈕回到原先的表單。',
