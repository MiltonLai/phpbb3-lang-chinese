...
$lang = array_merge($lang, array(
	...
	'BACKUP_NOTICE'					=> '請在升級前備份您的討論區, 以防在升級過程中丟失數據.',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> '您已經將您的討論區成功轉換為 phpBB 3.0, 您現在可以 <a href="../">訪問您的討論區</a>. 請在啟用新討論區前確認參數都已經正確設置. phpBB 的線上使用說明位於 <a href="http://www.phpbb.com/support/documentation/3.0/">會員使用手冊</a> 和 <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">技術支援版面</a>',
	...
	'DB_HOST_EXPLAIN'			=> 'DSN 表示 Data Source Name, 它只與 ODBC 有關. 在 PostgreSQL, 經由 UNIX domain socket 使用 localhost 連線至本機伺服器, 而經由 TCP 則以 127.0.0.1 連線。對于SQLite, 請輸入資料檔案的完整路徑',
	'DB_NAME'					=> '資料庫名稱',
	'DB_PASSWORD'				=> '資料庫密碼',
	'DB_PORT'					=> '資料庫伺服器連接埠',
	'DB_PORT_EXPLAIN'			=> '不用填寫, 除非您確定伺服器監聽一個非標準埠. ',
	'DB_UPDATE_NOT_SUPPORTED'	=> '非常抱歉, 升級程序無法升級版本低於 「%1$s」 的phpBB討論區. 您當前使用的討論區版本為 「%2$s」. 請升級至一個較新的版本後再執行此升級程序. 如果您需要幫助, 請到phpBB.com的技術支援版面提出.',
	...
	'FIREBIRD_DBMS_UPDATE_REQUIRED'		=> 'phpBB不再支援版本低於2.1的 Firebird/Interbase 資料庫. 請升級您的 Firebird 資料庫.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<h2>使用您的 phpBB3!</h2>
		<p>點選下面的連結將帶您到管理員控制面板 (ACP)下提交統計數據的界面. 花一些時間檢查設置選項是否可用. 記住可以使用線上說明文件檔位於 <a href="http://www.phpbb.com/support/documentation/3.0/">文件</a> 和 <a href="http://www.phpbb.com/community/viewforum.php?f=46">技術支援版面</a>, 檢視 <a href="%3$s">README</a> 以得到更多的訊息.</p><p><strong>請在使用討論區前刪除, 移動或重新命名install資料夾. 如果這個資料夾存在, 只有管理員控制面板才可以訪問.</strong></p>',
	'INSTALL_INTRO'				=> '歡迎安裝！',
	...
	'INST_ERR_DB_INVALID_PREFIX'=> '您輸入的資料庫前綴不正確. 前綴必須以英文字符開始并且只能包含英文字符, 數字及下劃線.',
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> '您安裝的 Firebird 版本太古老, 請升級至最低 2.1 版. ',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'   => '您的phpBB資料庫結構失效. phpBB檢測到您的資料庫結構源於MySQL 3.x/4.x版本, 但當前伺服器使用為MySQL %2$s.<br /><strong>在您繼續下一步之前, 您需要升級您的資料庫結構.</strong><br /><br />請參閱<a href="http://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">關於MySQL資料庫升級的教學資料</a>. 如果您遇到問題, 請訪問<a href="http://www.phpbb.com/community/viewforum.php?f=46">我們的技術支援版面</a>.',
	...
	'TABLE_PREFIX_EXPLAIN'		=> '資料表前綴必須以英文字符開始, 并且只能包含英文字符, 數字及下劃線.',
...
$lang = array_merge($lang, array(
	...
	'TRY_DOWNLOAD_METHOD'      => '您也許想嘗試下載已修改檔案的方式.<br />這是一種較穩妥並被推薦的方式.',
	...
	'UPDATE_INSTALLATION_EXPLAIN'	=> '本選項將升級您的phpBB安裝到最新版本. <br />在升級處理期間所有的檔案都將被檢查是否完整. 您可以檢視檔案和升級前的變化. <br /><br />檔案自動升級有兩種不同的方式. </p><h2>手動升級</h2><p>這個選項, 您只需要下載有改動的檔案以確保不會丟失你對其他檔案的修改. 下載後將檔案上傳到phpBB目錄的相應位置. 之後, 您可以再次進行檔案檢查, 檢查是否將檔案放到了正確的位置. </p><h2>通過FTP自動升級</h2><p>這個方法和第一個類似, 但是不需要下載有變動的檔案和手動上傳它們. 系統將為你自動做這個工作. 用這個方法進行升級您需要知道您的FTP登入的詳細訊息.  一旦完成設置, 系統將重新定向到檔案檢查功能完成系統升級. .<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '
	...
	'UPGRADE_INSTRUCTIONS'			=> '一項可用的新功能 <strong>%1$s</strong> 已發布。請閱讀 <a href="%2$s" title="%2$s"><strong>發布公告</strong></a> 以瞭解其所提供，以及如何更新。',
	'UPLOAD_METHOD'					=> '上傳方式',
	...
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> '您的討論區版本不是最新的.',
	'VERSION_UP_TO_DATE'		=> '您的版本是最新的, 沒有可用的更新. 您也許想進行一次討論區程式檔案的有效性檢查.',
	'VERSION_UP_TO_DATE_ACP'	=> '您的版本是最新的, 沒有可用的更新.',
