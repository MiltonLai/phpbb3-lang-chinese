...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> '如果您需要添加一個意見/反應請填寫下列表格。只可使用文字模式，不允許HTML, BBCode等語法格式.',
	'ADD_WARNING'			=> '發出警告',
	...
	'ALREADY_REPORTED_PM'	=> '這個私人訊息已經被舉報過了.',
	...
	'CHANGE_POSTER'			=> '改變作者',
	'CLOSE_PM_REPORT'		=> '關閉舉報',
	'CLOSE_PM_REPORT_CONFIRM'	=> '您確定要關閉這個舉報嗎？',
	'CLOSE_PM_REPORTS'		=> '關閉舉報',
	'CLOSE_PM_REPORTS_CONFIRM'	=> '您確定要關閉這些舉報嗎？',
	'CLOSE_REPORT'			=> '關閉舉報',
	'CLOSE_REPORT_CONFIRM'	=> '您確定要關閉這個舉報嗎？',
	'CLOSE_REPORTS'			=> '關閉舉報',
	'CLOSE_REPORTS_CONFIRM'	=> '您確定要關閉這些舉報嗎？',

	'DELETE_PM_REPORT'			=> '刪除舉報',
	'DELETE_PM_REPORT_CONFIRM'	=> '你確定要刪除這個舉報嗎？',
	'DELETE_PM_REPORTS'			=> '刪除舉報',
	'DELETE_PM_REPORTS_CONFIRM'	=> '您確定要刪除這些舉報嗎？',
	'DELETE_POSTS'				=> '刪除文章',
	...
	'LATEST_REPORTED_PMS'		=> '最新的5個私人訊息舉報',
	...
	'MCP_PM_REPORTS'				=> '訊息舉報',
	'MCP_PM_REPORT_DETAILS'			=> '舉報明細',
	'MCP_PM_REPORTS_CLOSED'			=> '已處理舉報',
	'MCP_PM_REPORTS_CLOSED_EXPLAIN'	=> '這是已經處理過的訊息舉報列表.',
	'MCP_PM_REPORTS_OPEN'			=> '未處理舉報',
	'MCP_PM_REPORTS_OPEN_EXPLAIN'	=> '這是等待處理的訊息舉報列表.',
	...
	'MERGE_POSTS_CONFIRM'	=> '您確認要移動選中的文章嗎?',
	'MERGE_TOPIC_EXPLAIN'	=> '使用下面的表單可以將選中的文章移動至另一個主題. 這些文章不會被重新排序, 就像這些文章當初就是發在那個主題下的. <br />請輸入目標的主題ID或點擊「選擇主題」 .',
	...
	'PM_REPORT_CLOSED_SUCCESS'	=> '舉報被成功關閉.',
	'PM_REPORT_DELETED_SUCCESS'	=> '舉報被成功刪除.',
	'PM_REPORTED_SUCCESS'		=> '私人訊息舉報發送成功.',
	'PM_REPORT_TOTAL'			=> '有<strong>1</strong>個私人訊息舉報待處理.',
	'PM_REPORTS_CLOSED_SUCCESS'	=> '選中的私人訊息已經關閉.',
	'PM_REPORTS_DELETED_SUCCESS'=> '選中的私人訊息已經刪除.',
	'PM_REPORTS_TOTAL'			=> '總共有 <strong>%d</strong> 個私人訊息舉報待處理.',
	'PM_REPORTS_ZERO_TOTAL'		=> '沒有待處理的訊息舉報.',
	'PM_REPORT_DETAILS'			=> '訊息舉報明細',
	'POSTER'					=> '作者',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> '使用這個表單來向討論區管理員舉報選取的內容. 舉報一般用於違反版面規則的情況. <strong>注意: 舉報私人訊息將使內容對於版主和管理員可見</strong>',
	'REPORT_NOTIFY'				=> '通知您',
