...
$lang = array_merge($lang, array(
	...
	'ATTACH_DISK_FULL'			=> '硬碟剩余空間不足, 無法上傳附加檔案.',
	...
	'DISALLOWED_CONTENT'		=> '上傳被終止, 因為檔案可能包含安全隱憂.',
	...
	'POST_NORMAL'				=> '普通',
	'POST_REVIEW'				=> '文章預覽',
	'POST_REVIEW_EDIT'			=> '文章檢視',
	'POST_REVIEW_EDIT_EXPLAIN'	=> '在您編輯的過程中這篇文章已經被其他會員更改. 您可能需要檢視一下新的文章內容以便調整自己的發文.',
	...
	'TOO_FEW_CHARS_LIMIT'		=> '您的正文長度為 %1$d 字元. 您的輸入不能少於 %2$d 個字元.',
	...
	'USER_CANNOT_FORUM_POST'	=> '您不能在這個版面發表文章，因為這個版面類型不支援。',
