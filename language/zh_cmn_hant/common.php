...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> '正體中文語系由 <a href="http://www.phpbbchina.com/creditinfo">PHPBB中文翻譯小組</a> & CRLin 維護製作',
	'DIRECTION'			=> 'ltr',
	...
	'AVATAR_DISALLOWED_CONTENT'		=> '檔案上傳被終止, 因為檔案可能含有安全隱憂.',
	...
	'CONFIRM'				=> '確認',
	'CONFIRM_CODE'			=> '確認碼',
	'CONFIRM_CODE_EXPLAIN'	=> '輸入您在圖片中看到的字元, 不需要區分大小寫。',
	...
	'IF'						=> '如果',
	'IMAGE'						=> '圖檔',
	'IMAGE_FILETYPE_INVALID'	=> '不支援圖檔類型：%d mimetype %s 。',
	...
	'LDAP_SEARCH_FAILED'				=> '搜尋 LDAP 目錄時發生錯誤.',
	'LEGEND'							=> '團隊',
	'LOCATION'							=> '來自',
	'LOCK_POST'							=> '鎖定文章',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> '為了防止暴力破解會員密碼, 論壇管理員要求您在超過最大嘗試次數後輸入一組確認碼。確認碼顯示在如下所示的圖片中。如果您有視力缺陷無法閱讀請聯繫 %s論壇管理員%s。',
	'LOGIN_ERROR_ATTEMPTS'				=> '您超出了討論區規定的最大嘗試次數。除了您的會員名稱和密碼外您還需要解決底下的 CAPTCHA。',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> '您的訪問未被Apache伺服器授權。',
	'LOGIN_ERROR_PASSWORD'				=> '您輸入了一個無效的密碼。請查證後重新輸入。如果一直存在問題請聯繫 %s論壇管理員%s。',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> '在討論區升級中無法轉換您的密碼. 請 %s申請一個新密碼%s. 如果您還遇到其他的問題, 請聯繫 %s論壇管理員%s.',
	'LOGIN_ERROR_USERNAME'				=> '您輸入了一個無效的會員名稱。請查證後重新輸入。如果一直存在問題請聯繫 %s論壇管理員%s。',
	...
	'NOTIFY_ADMIN'				=> '請通知論壇管理員或網站管理者.',
	'NOTIFY_ADMIN_EMAIL'		=> '請通知論壇管理員或網站管理者: <a href="mailto:%1$s">%1$s</a>',
	...
	'NO_NEW_POSTS'				=> '沒有新文章', // Not used anymore
	'NO_ONLINE_USERS'			=> '沒有註冊會員',
	'NO_POSTS'					=> '沒有文章',
	'NO_POSTS_TIME_FRAME'		=> '在選定的時間內沒有這個主題的文章。',
	'NO_FEED_ENABLED'			=> 'ATOM輸出尚未啟用.',
	'NO_FEED'					=> '請求的ATOM輸出無效.',
	...
	'SEARCH_UNREAD'				=> '檢視未讀文章',
	'SEARCH_USER_POSTS'			=> '搜索會員文章',
	'SECONDS'					=> '秒',
	'SELECT'					=> '選擇',
	...
	'TOO_LARGE'						=> '您輸入的值太大.',
	'TOO_LARGE_MAX_RECIPIENTS'		=> '您輸入的 <strong>每個私人訊息所允許的最大收件人數</strong> 之設定值太大.',
	'TOO_LONG'						=> '您輸入的值太長了.',
	...
	'TOO_MANY_VOTE_OPTIONS'			=> '您在投票中選取了過多的選項。',
	...
	'TOO_SMALL'						=> '您輸入的值太小.',
	'TOO_SMALL_MAX_RECIPIENTS'		=> '您輸入的 <strong>每個私人訊息所允許的最大收件人數</strong> 之設定值太小.',

	'TOPIC'				=> '主題',
	'TOPICS'			=> '主題',
	'TOPICS_UNAPPROVED'	=> '討論區中有未審核的文章.',
	'TOPIC_ICON'		=> '主題圖示',
	...
	'UNREAD_POST'			=> '未讀文章',
	'UNREAD_POSTS'			=> '未讀文章',
	'UNWATCH_FORUM_CONFIRM'		=> '您確認要取消訂閱這個版面嗎?',
	'UNWATCH_FORUM_DETAILED'	=> '您確認要取消訂閱 “%s” 版面嗎?',
	'UNWATCH_TOPIC_CONFIRM'		=> '您確認要取消訂閱這個主題嗎?',
	'UNWATCH_TOPIC_DETAILED'	=> '您確認要取消訂閱主題 “%s” 嗎?',
	'UNWATCHED_FORUMS'		=> '您已經取消訂閱所選的版面。',
	'UNWATCHED_TOPICS'		=> '您已經取消訂閱所選的主題。',
	'UNWATCHED_FORUMS_TOPICS'	=> '您將不再關注這些選取的文章。',
	'UPDATE'				=> '更新',
	'UPLOAD_IN_PROGRESS'	=> '正在上傳',
	'URL_REDIRECT'			=> '如果您的瀏覽器不支援 meta 重新轉向。請點擊 %s這裡%s 連結。',
	'USERGROUPS'			=> '會員群組',
	'USERNAME'				=> '會員名稱',
	'USERNAMES'				=> '會員名稱',
	'USER_AVATAR'			=> '頭像',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> '很抱歉您還不能使用此功能. 作為新註冊的會員您需要更多的參與後才能使用這些功能.',
	'USER_NEW_PERMISSION_DISALLOWED'	=> '很抱歉!您沒有權限使用這個功能。您只是剛在本站註冊，您需要有更多的參與，才可使用這個功能。',
	...
	'WARNINGS'			=> '警告',
	'WARN_USER'			=> '警告會員',
	'WATCH_FORUM_CONFIRM'	=> '您確認要訂閱這個版面嗎?',
	'WATCH_FORUM_DETAILED'	=> '您確認要訂閱 “%s” 版面嗎?',
	'WATCH_TOPIC_CONFIRM'	=> '您確認要訂閱這個主題嗎?',
	'WATCH_TOPIC_DETAILED'	=> '您確認要訂閱主題 “%s” 嗎?',
