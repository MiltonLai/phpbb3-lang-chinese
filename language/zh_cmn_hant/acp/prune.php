...
$lang = array_merge($lang, array(
	...
	'LAST_ACTIVE_EXPLAIN'		=> '輸入日期，使用<kbd>YYYY-MM-DD</kbd> 格式。輸入<kbd>0000-00-00</kbd>將刪除從未登入的會員, <em>Before</em> 和 <em>After</em> 條件將被忽略',

	'PRUNE_USERS_LIST'				=> '將被刪除的會員',
	'PRUNE_USERS_LIST_DELETE'		=> '使用選取的條件, 如下的會員帳號將被刪除.',
	'PRUNE_USERS_LIST_DEACTIVATE'	=> '使用選取的條件, 如下的會員帳號將被凍結.',

	'SELECT_USERS_EXPLAIN'		=> '在這裡輸入特定會員，他們將會用於上述的設定標準。創始人不會被刪除',
