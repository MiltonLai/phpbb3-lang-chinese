...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> '每個附加檔案的最大尺寸, 設置為0則僅受PHP設定的檔案最大尺寸限制.',
	...
	'CAT_FLASH_FILES'			=> 'Flash檔',
	'CAT_IMAGES'				=> '圖片',
	'CAT_QUICKTIME_FILES'		=> 'Quicktime多媒體檔',
	'CAT_RM_FILES'				=> 'RealMedia多媒體檔',
	'CAT_WM_FILES'				=> 'Windows Media多媒體檔',
	...
	'EXT_GROUP_ARCHIVES'			=> '压缩檔',
	'EXT_GROUP_DOCUMENTS'			=> '文件檔',
	'EXT_GROUP_DOWNLOADABLE_FILES'	=> '可下載的檔案',
	'EXT_GROUP_FLASH_FILES'			=> 'Flash檔',
	'EXT_GROUP_IMAGES'				=> '圖片檔',
	'EXT_GROUP_PLAIN_TEXT'			=> '純文字檔',
	'EXT_GROUP_QUICKTIME_MEDIA'		=> 'Quicktime多媒體檔',
	'EXT_GROUP_REAL_MEDIA'			=> 'Real多媒體檔',
	'EXT_GROUP_WINDOWS_MEDIA'		=> 'Windows多媒體檔',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> '當防盜鏈功能啟用後 - <strong>允許列表</strong> 和 <strong>拒絕列表</strong> 用於設定特例情況',
