...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_FUNC_OVERLOAD'					=> '重載函式的設定不正確',
	'ERROR_MBSTRING_FUNC_OVERLOAD_EXPLAIN'			=> '<var>mbstring.func_overload</var> 必須設置為 0 或 4. 您可以通過 <samp>PHP information</samp> 介面查看當前設定.',
	'ERROR_MBSTRING_ENCODING_TRANSLATION'			=> '空白字符配置不正確',
	'ERROR_MBSTRING_ENCODING_TRANSLATION_EXPLAIN'	=> '<var>mbstring.encoding_translation</var> 必須設置為 0. 您可以通過 <samp>PHP information</samp> 介面查看當前設定.',
	'ERROR_MBSTRING_HTTP_INPUT'						=> 'HTTP 輸入字符轉換配置不正確',
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> 必須設置為 <samp>pass</samp>. 您可以通過 <samp>PHP information</samp> 介面查看當前設定.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP 輸出字符轉換配置不正確',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> 必須設置為 <samp>pass</samp>. 您可以通過 <samp>PHP information</samp> 介面查看當前設定.',
	...
	'PHP_VERSION_OLD'	=> '當前伺服器上的PHP版本太舊, 新的phpBB將不再支持這個版本的PHP. %sDetails%s', 
	...
	'PURGE_SESSIONS'			=> '清除所有會話',
	'PURGE_SESSIONS_CONFIRM'	=> '您確認要清除所有會話嗎? 這會讓所有正在瀏覽的會員登出論壇.',
	'PURGE_SESSIONS_EXPLAIN'	=> '清除所有會話. 這會讓所有正在瀏覽的會員登出論壇.',
	...
	'VALUE'					=> '值',
	'VERSIONCHECK_FAIL'			=> '無法獲取最新版本訊息.',
	'VERSIONCHECK_FORCE_UPDATE'	=> '再次檢查版本',
	'VIEW_ADMIN_LOG'		=> '檢視管理員日誌',
	'VIEW_INACTIVE_USERS'	=> '檢視凍結帳號',

	'WELCOME_PHPBB'			=> '歡迎來到phpBB',
	'WRITABLE_CONFIG'      => '您的論壇配置檔 (config.php) 處於可寫狀態. 我們強烈建議您將權限更改為640, 或者至少為644(例如: <a href="http://en.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php).',
));
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> '請發送您的服務器和論壇設置訊息至phpBB官方以便於進行統計分析. 此訊息不會包含任何與您或您的論壇的隱私數據. 所有數據都是完全<strong>匿名</strong>的. 我們會在今後的phpBB版本開發中參考收集到的訊息. 統計的結果會向公眾公開, 並提供給PHP語言項目的開發團隊.',
	'EXPLAIN_SHOW_STATISTICS'	=> '使用下面的按鈕您可以檢視發送的內容.',
	'DONT_SEND_STATISTICS'		=> '返回管理員控制面板, 如果您不希望發送統計訊息給phpBB.',
	'GO_ACP_MAIN'				=> '前往管理員控制面板首頁',
	'HIDE_STATISTICS'			=> '隱藏細節',
	'SEND_STATISTICS'			=> '發送統計訊息',
	'SHOW_STATISTICS'			=> '顯示細節',
	'THANKS_SEND_STATISTICS'	=> '非常感謝您的參與, phpBB團隊向您致敬!',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_FEED'			=> '<strong>更改ATOM設定</strong>',
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>已更改反廣告機器人設置</strong>',
	...
	'LOG_PM_REPORT_CLOSED'		=> '<strong>關閉短訊舉報</strong><br />» %s',
	'LOG_PM_REPORT_DELETED'		=> '<strong>刪除短訊舉報</strong><br />» %s',
	...
	'LOG_FORUM_COPIED_PERMISSIONS'			=> '<strong>複製版面權限</strong> 自 %1$s<br />» %2$s',
	...
	'LOG_GENERAL_ERROR'	=> '<strong>發生錯誤</strong>: %1$s <br />» %2$s',
	...
	'LOG_USERS_APPROVED'	=> '<strong>會員被批准進入群組</strong> %1$s<br />» %2$s',
	'LOG_USERS_PENDING'		=> '<strong>會員申請加入 「%1$s」 並等待批准</strong><br />» %2$s',

	'LOG_IMAGE_GENERATION_ERROR'	=> '<strong>建立圖片時出錯</strong><br />» 錯誤位於 %1$s 行 %2$s: %3$s',
	...
	'LOG_PURGE_SESSIONS'		=> '<strong>清除會話</strong>',
	...
	'LOG_USER_DEL_OUTBOX'	=> '<strong>清空會員發件箱</strong><br />» %s',
	...
	'LOG_USER_REMOVED_NR'	=> '<strong>關閉新註冊標記於會員</strong><br />» %s',
	...
	'LOG_WARNING_DELETED'		=> '<strong>刪除會員警告</strong><br />» %s',
	'LOG_WARNINGS_DELETED'		=> '<strong>刪除 %2$s 起會員警告</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
	'LOG_WARNINGS_DELETED_ALL'	=> '<strong>刪除所有會員警告</strong><br />» %s',
