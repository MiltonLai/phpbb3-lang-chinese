...
$lang = array_merge($lang, array(
	...
	'COPY_PERMISSIONS_EXPLAIN'		=> '為了方便新版面的權限設置, 您可以複製一個現有的版面權限至新版面.',
	...
	'COPY_TO_ACL'					=> '另外, 您也可以為這個版面 %s 設定新權限 %s .',
	'CREATE_FORUM'					=> '建立新版面',
	...
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> '啟用後會員在這個版面可以通過快速回覆來回覆文章. 如果全局設定中停用了快速回覆, 這裡的選項將不起作用.',
	'ENABLE_RECENT'					=> '顯示活躍文章',
	'ENABLE_RECENT_EXPLAIN'			=> '如果設置為是, 這個版面的主題將顯示在活躍文章列表中.',
	'ENABLE_TOPIC_ICONS'			=> '允許主題圖示',

	'FORUM_ADMIN'						=> '版面管理',
	'FORUM_ADMIN_EXPLAIN'				=> '在phpBB3中所有分類都是基於版面. 每個版面可以擁有無限的子版面, 並且您可以設置哪些能發文哪些不能. (例如是否顯示為分區). 這裡您能添加, 編輯, 刪除, 鎖定, 解鎖各個版面並設置一些額外控制. 如果您的文章和主題統計失去同步, 您可以重新統計一下版面.',
	'FORUM_AUTO_PRUNE'					=> '開啟自動刪除',
	'FORUM_AUTO_PRUNE_EXPLAIN'			=> '刪除版面的主題, 在下面設置頻率/時間參數.',
	'FORUM_CREATED'						=> '版面建立完成.',
	'FORUM_DATA_NEGATIVE'				=> '刪除參數不能為負.',
	'FORUM_DESC_TOO_LONG'				=> '版面描述太長, 不能超過4000個字元.',
	'FORUM_DELETE'						=> '刪除版面',
	...
	'FORUM_LINK_EXPLAIN'				=> '會員點擊這個版面後前往的完整網址(包含協議頭, 例如 <samp>http://</samp>).',
