...
$lang = array_merge($lang, array(
	'ACP_BBCODES_EXPLAIN'		=> 'BBCode是一種HTML的特殊實現, 可以產生各種頁面效果而不會有安全隱憂. 這裡您可以添加/刪除/編輯自定義BBCode',
	'ADD_BBCODE'				=> '添加BBCode',

	'BBCODE_DANGER'				=> '您添加的BBCode似乎在HTML屬性中使用了 {TEXT} 標記. 這可能會帶來 XSS 安全隱憂. 請使用更安全的 {SIMPLETEXT} 或 {INTTEXT} 類型. 除非您明白此設定的含義並確信使用 {TEXT} 並不會帶來問題.',
	'BBCODE_DANGER_PROCEED'		=> '我明白, 繼續', //'I understand the risk',
	...
	'tokens'	=>	array(
		'TEXT'			=> '任何文字, 包括外文字元, 數字, 等等…在HTML標記中請不要使用, 應該使用SIMPLETEXT, INTTEXT和IDENTIFIER',
		'SIMPLETEXT'	=> '拉丁字元 (A-Z), 數字, 空格, 逗號, 點, 減號, 加號, 連字號和底線',
		'INTTEXT'		=> 'Unicode字符, 數字, 空格, 逗號, 點, 減號, 加號, 連字號和底線.',
...
$lang = array_merge($lang, array(
	...
	'SMILIE_NO_FILE'			=> '忽略表情 “%s”, 因為無法找到對應檔案.',
...
// Ranks
$lang = array_merge($lang, array(
	'ACP_RANKS_EXPLAIN'		=> '使用這個表單您可以添加, 編輯, 檢視和刪除等級. 您也可以建立自定義等級, 使用在會員管理中.',
	'ADD_RANK'				=> '添加新等級',
