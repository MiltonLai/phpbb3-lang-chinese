...
$lang = array_merge($lang, array(
	...
	'CANNOT_BAN_ANONYMOUS'			=> '您不被允許去封鎖匿名帳戶. 可以在權限標籤設定匿名使用者權限.',
	...
	'CANNOT_SET_FOUNDER_INACTIVE'	=> '您需要先啟用會員才能提升他們為創始人, 只有已啟用的會員才能被提升.',
	'CONFIRM_EMAIL_EXPLAIN'			=> '您只有在改變會員email位址的時候才需要指定這個.',

	'DELETE_POSTS'			=> '刪除文章',
	'DELETE_USER'			=> '刪除會員',
	'DELETE_USER_EXPLAIN'	=> '請注意刪除的會員將不可恢復, 他發出的站內私信尚未被收件人閱讀的, 也將被刪除',
	...
	'MOVE_POSTS_EXPLAIN'	=> '請問您要移動這個會員發表的所有文章到哪個版面',
	...
	'USER_LIFTED_NR'				=> '成功關閉此會員的新會員狀態.',
	'USER_NO_ATTACHMENTS'			=> '沒有可顯示的附加檔案.',
	'USER_NO_POSTS_TO_DELETE'			=> '會員沒有可保留或刪除的文章.',
	'USER_OUTBOX_EMPTIED'			=> '會員的私人訊息發件夾已清空.',
	'USER_OUTBOX_EMPTY'				=> '會員的私人訊息發件夾是空的.',
	...
	'USER_WARNING_LOG_DELETED'		=> '無可用訊息. 可能日誌記錄已經被刪除.',
	'USER_TOOLS'					=> '基本工具',
));
