...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_MIN_SEARCH_CHARS_EXPLAIN'	=> '至少有這麼多字元的字詞被索引，以便搜尋。您或您的主機只能由 MySQL 的設定來改變。',
	'FULLTEXT_MYSQL_MAX_SEARCH_CHARS_EXPLAIN'	=> '沒有比這更多的字元之字詞被索引，以便搜尋。您或您的主機只能由 MySQL 的設定來改變。.',
    ...
    'MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'      => '用於限制會員搜尋時使用的關鍵詞個數. 填寫0則不作限制.',
