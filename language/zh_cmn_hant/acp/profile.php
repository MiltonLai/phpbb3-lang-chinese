...
$lang = array_merge($lang, array(
	...
	'DISPLAY_ON_VT'					=> '於主題閱讀頁面顯示',
	'DISPLAY_ON_VT_EXPLAIN'			=> '啟用後, 此欄位會顯示於主題閱讀頁面中的會員資料中.',
	'DISPLAY_PROFILE_FIELD'			=> '會員公開資料中顯示',
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> '在檢視文章, 檢視資料, 檢視會員列表時顯示, 如果在負載設置中啟用. 預設只顯示在檢視會員資料中.',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> '只有管理員和版主可以檢視/填寫這個欄位. 如果未啟用顯示在會員控制面板選項, 會員將無法看見這個欄位, 並且只能由管理員修改.',
	...
	'REQUIRED_FIELD'			=> '必填欄位',
	'REQUIRED_FIELD_EXPLAIN'	=> '強制會員填寫的欄位. 這將在註冊過程和會員控制面板中顯示這個欄位, 如果設定為不顯示於註冊過程, 則在會員編輯資料時要求填寫.',
	'ROWS'						=> '行',

	'SAVE'							=> '保存',
	'SECOND_OPTION'					=> '第二選項',
	'SHOW_NOVALUE_FIELD'			=> '顯示未選擇的資料欄位',
	'SHOW_NOVALUE_FIELD_EXPLAIN'	=> '如果可選項未設置或必須的欄位未填寫, 是否顯示.',
