...
$lang = array_merge($lang, array(
	...
	'ACL_NO'				=> '否',
	'ACL_VIEW'				=> '檢視權限',
	'ACL_VIEW_EXPLAIN'		=> '這裡您可以看到會員和群組擁有的有效權限. 紅色方形表示會員/群組沒有該權限, 綠色方形表示會員/群組擁有該權限.',
	'ACL_YES'				=> '是',
	...
	'ACP_FORUM_PERMISSIONS_COPY_EXPLAIN'		=> '這裡您可以複製一個版面的權限到其他版面.',
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> '這裡您可以將全區權限設置到權限群組 - 會員權限, 超級版主權限和管理員權限. 會員權限包含使用頭像, 發送私人訊息等等, 超級版主權限包含審閱文章, 管理主題, 管理封鎖等等, 而管理員權限包含更改權限, 設置BBCode, 管理版面等等. 只有少數的情況下才需要單獨的會員權限設置, 推薦的方式是將會員歸類到不同的群組, 再賦予群組不同的權限.',
	...
	'ACP_VIEW_ADMIN_PERMISSIONS_EXPLAIN'		=> '這裡您可以檢視給選取的會員/群組設置的有效管理權限',
	...
	'COPY_PERMISSIONS_CONFIRM'				=> '您確認要執行此項操作嗎? 這將覆蓋目標原先的所有權限設定.',
	'COPY_PERMISSIONS_FORUM_FROM_EXPLAIN'	=> '權限複製的來源版面.',
	'COPY_PERMISSIONS_FORUM_TO_EXPLAIN'		=> '權限複製的目的版面.',
	'COPY_PERMISSIONS_FROM'					=> '複製權限自',
	'COPY_PERMISSIONS_TO'					=> '應用權限至',
	...
	'ROLE_DESCRIPTION_FORUM_NEW_MEMBER'		=> '為新會員所在群組指定的角色; 包含 <samp>從不</samp> 設定以鎖定新會員權限.',
	...
	'ROLE_DESCRIPTION_USER_NEW_MEMBER'		=> '為新會員所在群組指定的角色; 包含 <samp>從不</samp> 設定以鎖定新會員權限.',
	...
	'TRACE_USER_NO_TOTAL_NO'				=> '會員權限設置為 <samp>否</samp> 而原值也設置為否, 所以最終回復預設值 <samp>從不</samp>.',
