...
$lang = array_merge($lang, array(
	...
	'SITE_NAME'						=> '網站名稱',
	'SYSTEM_DST'					=> '啟用日光節約時間',
	'SYSTEM_TIMEZONE'				=> '訪客的時區',
	'SYSTEM_TIMEZONE_EXPLAIN'			=> '未登入的使用者(訪客，機器人)顯示的時間。登入的使用者顯示註冊時設定的時區，可以在會員控制面板作更改。',
	'WARNINGS_EXPIRE'				=> '警告失效時間',
	'WARNINGS_EXPIRE_EXPLAIN'		=> '會員警告自動消失所需要的天數, 0為一直警告',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PM_REPORT'			=> '允許會員舉報不良私人訊息',
	'ALLOW_PM_REPORT_EXPLAIN'	=> '啟用後, 會員可增加舉報私人訊息的選項, 隨後被舉報的訊息會出現在版主控制面板上.',
	'ALLOW_QUICK_REPLY'			=> '允許快速回覆',
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> '關閉此選項將關閉整個論壇的快速回覆, 當啟用後由各個版面的設定決定其快速回覆功能是否打開.',
	'ALLOW_QUICK_REPLY_BUTTON'	=> '提交後將開啟所有版面的快速回覆功能',
	'ALLOW_SIG'					=> '允許簽名檔',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AVATARS'					=> '啟用頭像',
	'ALLOW_AVATARS_EXPLAIN'			=> '允許使用頭像;<br />如果您禁用了頭像功能, 論壇將不再顯示會員頭像, 但是會員在會員控制面板中仍可以檢視和下載自己的頭像.',

	'ALLOW_LOCAL'					=> '允許使用系統頭像簿',
	'ALLOW_REMOTE'					=> '允許使用外部頭像',
	'ALLOW_REMOTE_EXPLAIN'			=> '允許從其他網站連結頭像',
	'ALLOW_REMOTE_UPLOAD'			=> '允許外部連結上傳頭像',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> '允許會員自另一網站上傳頭像.',
	'ALLOW_UPLOAD'					=> '允許頭像上傳',
	...
	'MAX_FILESIZE_EXPLAIN'			=> '允許上傳的頭像檔案大小, 為0則僅受PHP設定的最大檔案尺寸限制',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL'					=> '頂文章間隔',
	'BUMP_INTERVAL_EXPLAIN'			=> '主題中最後一篇文章發表後的天數/小時數/分鐘數, 設定為0則關閉此功能.',
	'CHAR_LIMIT'					=> '每篇文章最多字元數',
	'CHAR_LIMIT_EXPLAIN'			=> '設置為0則不作限制.',
	'DELETE_TIME'					=> '文章刪除時限',
	'DELETE_TIME_EXPLAIN'			=> '設定新文章的可刪除時間. 設置為0則不作限制.',
	...
	'MIN_CHAR_LIMIT'				=> '文章和私人訊息的最小字元數限制',
	'MIN_CHAR_LIMIT_EXPLAIN'		=> '會員在提交一篇文章或一封私人訊息時的最小內容長度, 最小值為1.',
	'POSTING'						=> '發表文章',
	'POSTS_PER_PAGE'				=> '每頁文章數',
	'QUOTE_DEPTH_LIMIT'				=> '每篇文章中的最大引言嵌入數',
	'QUOTE_DEPTH_LIMIT_EXPLAIN'		=> '設置為0則不作限制.',
	'SMILIES_LIMIT'					=> '每篇文章中的最多表情符號數量',
	'SMILIES_LIMIT_EXPLAIN'			=> '設置為0則不作限制.',
	'SMILIES_PER_PAGE'				=> '每頁表情符號數量',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT'			=> '新會員發文限制',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> '新會員會被歸入 <em>新註冊會員</em> 群組直到其發表足夠多的文章. 您可以使用此會員群組的群組權限來限制其使用私人訊息以及方便發文審核. <strong>設定為0則不啟用此項功能.</strong>',
	'NEW_MEMBER_GROUP_DEFAULT'		=> '設定新註冊會員群組為預設群組',
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> '如果設定為是, 並且設定了新會員發文數量限制, 新會員不僅會加入到 <em>新註冊會員</em> 群組, 這個會員群組也會成為他的預設群組. 這將方便管理員為該群組指定一個預設等級和群組頭像.',
...
//	'ACC_USER_ADMIN'			=> '會員 + 管理員',
	...
	'REG_LIMIT'					=> '註冊嘗試次數',
	'REG_LIMIT_EXPLAIN'			=> '解決反垃圾郵件機器人的任務時使用者可以在被鎖定 session 前的嘗試次數.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_MANAGEMENT_EXPLAIN'		=> '此外掛提供多種ATOM輸出, 並轉換BBCode為可閱讀的內容.',

	'ACP_FEED_GENERAL'					=> '綜合設定',
	'ACP_FEED_POST_BASED'				=> '基於文章的輸出設定',
	'ACP_FEED_TOPIC_BASED'				=> '基於話題的輸出設定',
	'ACP_FEED_SETTINGS_OTHER'			=> '其它設定',

	'ACP_FEED_ENABLE'					=> '啟用ATOM',
	'ACP_FEED_ENABLE_EXPLAIN'			=> '對整個論壇啟用或停止ATOM輸出.<br />關閉此選項會關閉論壇的所有ATOM輸出, 以下的選項將不再起作用.',
	'ACP_FEED_LIMIT'					=> '數量',
	'ACP_FEED_LIMIT_EXPLAIN'			=> 'ATOM輸出條目的最大數量.',

	'ACP_FEED_OVERALL'					=> '啟用整個論壇的ATOM輸出',
	'ACP_FEED_OVERALL_EXPLAIN'			=> '整個論壇的新帖.',
	'ACP_FEED_FORUM'					=> '啟用單個版面ATOM輸出',
	'ACP_FEED_FORUM_EXPLAIN'			=> '單個版面和子版面的最新文章.',
	'ACP_FEED_TOPIC'					=> '啟用單個話題ATOM輸出',
	'ACP_FEED_TOPIC_EXPLAIN'			=> '單個話題的最新文章.',

	'ACP_FEED_TOPICS_NEW'				=> '啟用新主題ATOM輸出',
	'ACP_FEED_TOPICS_NEW_EXPLAIN'		=> '最新主題ATOM輸出最近發表的主題及其第一篇文章的內容.',
	'ACP_FEED_TOPICS_ACTIVE'			=> '啟用活躍主題ATOM輸出',
	'ACP_FEED_TOPICS_ACTIVE_EXPLAIN'	=> '活躍主題ATOM輸出最近發表的活躍主題及其最後一篇回覆的內容.',
	'ACP_FEED_NEWS'						=> '各版面最新文章ATOM輸出',
	'ACP_FEED_NEWS_EXPLAIN'				=> '從以下版面中各摘取最新的一篇文章. 如果無指定版面則關閉此項輸出.<br />要選定或反選多個版面, 請按住<samp>CTRL</samp>鍵用滑鼠左鍵點選.',

	'ACP_FEED_OVERALL_FORUMS'			=> '啟用版面ATOM輸出',
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> '所有版面ATOM輸出會顯示所有版面列表.',

	'ACP_FEED_HTTP_AUTH'				=> '允許HTTP驗證',
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> '啟用此驗證後, 用戶可以訪問到其他無權限用戶所無法訪問的內容, 需要添加<samp>auth=http</samp>參數到URL. 請注意一些PHP版本需要在.htaccess檔案上做額外的設置. 更多訊息請搜索相關文章.',
	'ACP_FEED_ITEM_STATISTICS'			=> '條目統計',
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> '顯示各<br />(作者, 日期和時間, 回覆數, 檢視次數)',
	'ACP_FEED_EXCLUDE_ID'				=> '排除下列版面',
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> '來自這些版面的內容將<strong>不會被輸出</strong>. 無指定版面則輸出所有版面內容.<br />要選定或反選多個版面, 請按住<samp>CTRL</samp>鍵用滑鼠左鍵點選.',
));

// Visual Confirmation Settings
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> '這裡你可以選擇和設定外掛以阻止灌水惡意程式自動提交表單. 這些外掛通常提供 <em>CAPTCHA</em> 功能以困擾使用者測試.',
	'AVAILABLE_CAPTCHAS'					=> '可用外掛',
	'CAPTCHA_UNAVAILABLE'					=> '無法使用外掛因為伺服器環境不支援.',
	'CAPTCHA_GD'							=> 'GD 圖片',
	'CAPTCHA_GD_3D'							=> 'GD 3D 圖片',
	'CAPTCHA_GD_FOREGROUND_NOISE'			=> '前景干擾',
	'CAPTCHA_GD_EXPLAIN'					=> '使用 GD 產生更進階的反廣告機器人圖片.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> '使用更難以辨認的前景干擾.',
	'CAPTCHA_GD_X_GRID'						=> 'X軸背景干擾',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> '使用較低設定產生更難以辨認的圖檔. 0 將停用X軸的背景干擾.',
	'CAPTCHA_GD_Y_GRID'						=> 'Y軸背景干擾',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> '使用較低設定產生更難以辨認的圖檔. 0 將停用Y軸的背景干擾.',
	'CAPTCHA_GD_WAVE'                  => '畸變波',
	'CAPTCHA_GD_WAVE_EXPLAIN'            => '在圖檔上使用畸變波.',
	'CAPTCHA_GD_3D_NOISE'               => '添加3D干擾',
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'         => '在圖檔的字母上方添加干擾.',
	'CAPTCHA_GD_FONTS'                  => '使用不同字體',
	'CAPTCHA_GD_FONTS_EXPLAIN'            => '此設定控制字體使用的數量. 您可以使用預設的設定或導入新字體, 或添加小寫字元.',
	'CAPTCHA_FONT_DEFAULT'               => '預設',
	'CAPTCHA_FONT_NEW'                  => '新字體',
	'CAPTCHA_FONT_LOWER'               => '使用小寫',
	'CAPTCHA_NO_GD'							=> '只是簡單圖檔',
	'CAPTCHA_PREVIEW_MSG'					=> '您的可視化驗證設定尚未保存, 這只是預覽.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> '您目前設定下的驗證圖檔預覽.',

	'CAPTCHA_SELECT'						=> '安裝可視化驗證外掛',
	'CAPTCHA_SELECT_EXPLAIN'				=> '下拉框顯示被識別的可用的驗證外掛. 灰色項為需要預先設定方可使用的外掛.',
	'CAPTCHA_CONFIGURE'						=> '外掛設定',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> '設定選取的外掛.',
	'CONFIGURE'								=> '設定',
	'CAPTCHA_NO_OPTIONS'					=> '此外掛沒有設定選項.',

	'VISUAL_CONFIRM_POST'					=> '為訪客發文啟用反廣告機器人可視化驗證',
	'VISUAL_CONFIRM_POST_EXPLAIN'			=> '當匿名訪客發表文章時會被要求輸入反廣告機器人驗證圖檔以防止發佈垃圾訊息.',
	'VISUAL_CONFIRM_REG'					=> '為註冊啟用反廣告機器人可視化驗證',
	'VISUAL_CONFIRM_REG_EXPLAIN'			=> '在新會員註冊時會被要求輸入反廣告機器人驗證圖檔以防止自動註冊.',
	'VISUAL_CONFIRM_REFRESH'				=> '允許會員重新整理反廣告機器人驗證圖檔',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> '允許會員取得新的驗證碼. 當會員無法有效辨認目前驗證圖檔時會有幫助. 注意有些外掛不支援這項功能.',
));
...
$lang = array_merge($lang, array(
	...
	'YES_ANON_READ_MARKING_EXPLAIN'	=> '為訪客儲存已讀/未讀狀態. 如果停用, 對於訪客所有文章將標記為已讀.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> '產生的頁面將在發送到瀏覽器前被壓縮. 這將減少網路流量但是會增加伺服器和客戶端的CPU負載. 需要zlib支援',
...
$lang = array_merge($lang, array(
	...
	'IP_LOGIN_LIMIT_MAX'			=> '每個IP地址的最大登錄嘗試次數',
	'IP_LOGIN_LIMIT_MAX_EXPLAIN'	=> '對單個IP的登錄嘗試次數的限制. 超過這個次數後, 會激活反機器人的驗證. 輸入0則表示不啟用這項功能.',
	'IP_LOGIN_LIMIT_TIME'			=> '登錄嘗試超時時間',
	'IP_LOGIN_LIMIT_TIME_EXPLAIN'	=> '在這個時間後, 將重置登錄嘗試次數.',
	'IP_LOGIN_LIMIT_USE_FORWARDED'	=> '通過<var>X_FORWARDED_FOR</var>頭信息限制登錄嘗試次數',
	'IP_LOGIN_LIMIT_USE_FORWARDED_EXPLAIN'	=> '通過<var>X_FORWARDED_FOR</var>而不是IP來限制登錄嘗試次數. <br /><em><strong>注意:</strong> 如果您使用了代理服務器, 僅當<var>X_FORWARDED_FOR</var>這個值被設置為可信的參數時, 才啟用這個功能.</em>',
	'MAX_LOGIN_ATTEMPTS'			=> '對每個會員的最大登錄嘗試次數',
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> '對單個會員的登錄嘗試次數的限制. 超過這個次數後, 會激活反機器人的驗證. 輸入0則表示不啟用這項功能.',
	'NO_IP_VALIDATION'				=> '無',
	'NO_REF_VALIDATION'				=> '無',
	'PASSWORD_TYPE'					=> '密碼複雜度',
...
$lang = array_merge($lang, array(
	...
	'BOARD_HIDE_EMAILS_EXPLAIN'		=> '這個功能使Email位址完全隱藏.',
	...
	'ENABLE_EMAIL_EXPLAIN'			=> '如果停用, 討論區將不會發送任何Email. <em>注意選擇會員自行啟用需要啟用此項功能. 如果目前設定為會員自行啟用和管理員啟用, 則停用此項功能將使會員無需以Email啟用.</em>',
...
// Jabber settings
$lang = array_merge($lang, array(
	'ACP_JABBER_SETTINGS_EXPLAIN'	=> '這裡您可以啟用並控制會員使用Jabber發送及時訊息和討論區通知. Jabber是任何人都可以使用的開放原始碼協議. 一些Jabber伺服器提供允許您聯絡其他網路會員的通道. 並非所有的伺服器都提供這樣的通道, 協議上的變化將使得操作失效. 請確認輸入的是已經註冊的帳號訊息, phpBB將會使用你這裡輸入的資料.',
	...
	'JAB_PASSWORD_EXPLAIN'		=> '<em><strong>注意:</strong> 此密碼將以明文保存在資料庫中, 任何擁有資料庫訪問權限或可以訪問此頁的用戶都可以看到此密碼.</em>',
	'JAB_PORT'					=> 'Jabber連接埠',
	...
	'JAB_USERNAME_EXPLAIN'		=> '請指定一個已經註冊的會員, 不要指望phpbb驗證此會員是否有效. 如果您僅僅指定一個會員名稱, 那麼您的JID將是您指定的會員名稱和伺服器名稱, 否則您需要指定一個有效的JID, 例如user@jabber.org.',
));
